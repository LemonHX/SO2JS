...
rust_runtime_functions!(
    ...
    Float16ArrayConstructor::construct,
    ...
    StringPrototype::anchor,
    StringPrototype::big,
    StringPrototype::blink,
    StringPrototype::bold,
    StringPrototype::fixed,
    StringPrototype::font_color,
    StringPrototype::font_size,
    StringPrototype::italics,
    StringPrototype::link,
    StringPrototype::small,
    StringPrototype::strike,
    StringPrototype::sub,
    StringPrototype::sup,
